...
var bottaApp = angular.module('bottaAppModule', ['ngRoute', 'ngResource']);

bottaApp.controller('userController', function ($scope, userFactory) {
	$scope.status;
	$scope.users;
	...
	// UserFactory
	bottaApp.factory('userFactory', ['$http', function($http) {
