    ...
    drop table botta.T_City cascade constraints;

    drop table botta.T_Code cascade constraints;

    drop table botta.T_Contact cascade constraints;

    drop table botta.T_Country cascade constraints;

    drop table botta.T_Customer cascade constraints;

    drop table botta.T_Customer_Info cascade constraints;

    drop table botta.T_R_CITY_REGION cascade constraints;

    drop table botta.T_R_CONTACT_CITY cascade constraints;

    drop table botta.T_R_CONTACT_CODE cascade constraints;

    drop table botta.T_R_CONTACT_COUNTRY cascade constraints;

    drop table botta.T_R_CONTACT_CUSTOMER cascade constraints;

    drop table botta.T_R_CONTACT_REGION cascade constraints;

    drop table botta.T_R_CONTACT_STATE cascade constraints;

    drop table botta.T_R_CUSTOMER_CODE cascade constraints;

    drop table botta.T_R_CUSTOMER_CUSTOMER_INFO cascade constraints;

    drop table botta.T_R_CUSTOMER_INFO_CODE cascade constraints;

    drop table botta.T_R_CUSTOMER_USER cascade constraints;

    drop table botta.T_R_REGION_STATE cascade constraints;

    drop table botta.T_R_STATE_COUNTRY cascade constraints;

    drop table botta.T_R_USER_CODE cascade constraints;

    drop table botta.T_R_USER_ROLE cascade constraints;

    drop table botta.T_Region cascade constraints;

    drop table botta.T_Role cascade constraints;

    drop table botta.T_State cascade constraints;

    drop table botta.T_User cascade constraints;

    drop sequence botta_sequence;
    ...
    create sequence botta_sequence;
